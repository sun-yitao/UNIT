...
def get_data_loader_list(root, file_list, batch_size, train, new_size=None,
    ...
    transform_list = [transforms.ToTensor(),
                      transforms.Normalize((0.5, 0.5, 0.5),
                                           (0.5, 0.5, 0.5))]
    transform_list = [transforms.Resize((height, width))] + transform_list if crop else transform_list
...
def get_data_loader_folder(input_folder, batch_size, train, new_size=None,
    ...
    transform_list = [transforms.ToTensor(),
                      transforms.Normalize((0.5, 0.5, 0.5),
                                           (0.5, 0.5, 0.5))]
    transform_list = [transforms.Resize((height, width), interpolation=Image.LANCZOS)] + transform_list if new_size is not None else transform_list
